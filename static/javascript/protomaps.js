    ...
    return [
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[9, 3], [12, 4], [17, 8], [20, 22]]);
          }
        }),
        filter: (f) => {
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[13, 3], [17, 6], [20, 18]]);
          }
        }),
        filter: (f) => {
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[14, 2], [17, 5], [20, 15]]);
          }
        }),
        filter: (f) => {
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[5, 0.5], [11, 2.5], [16, 7], [20, 30]]);
          }
        }),
        filter: (f) => {
          return f["pmap:kind"] == "highway";
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[9, 2], [12, 3], [17, 6], [20, 20]]);
          }
        }),
        filter: (f) => {
          return f["pmap:kind"] == "major_road";
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[13, 2], [17, 4], [20, 15]]);
          }
        }),
        filter: (f) => {
          return f["pmap:kind"] == "medium_road";
      ...
      },
      {
        ...
        symbolizer: new LineSymbolizer({
          ...
          width: (z) => {
            return exp(z, 1.4, [[14, 1], [17, 3], [20, 13]]);
          }
        }),
        filter: (f) => {
          return f["pmap:kind"] == "minor_road";
    ...
    load() {
      return __async(this, null, function* () {
        ...
        if (typeof icons === "string" && icons.endsWith(".html")) {
          let c = yield fetch(icons);
          let str = yield c.text();
